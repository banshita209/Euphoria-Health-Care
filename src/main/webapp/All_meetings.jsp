...
<title>Euphoria - all meetings</title>
					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">All Confirmed Meetings</h2>
								<div>
									<ul class="breadcrumb">
										<!-- 	<li class="breadcrumb-item"><a href="db-all.html"><i
												class="ti ti-home"></i></a></li>
										<li class="breadcrumb-item active">All Confirmed Meetings</li> -->
									</ul>
								</div>
							</div>
						</div>
													...
													<c:forEach var="meeting" items="${meetings}">
														<tr>
															...
															<td><span style="width: 100px;"><span
																	class="badge-text badge-text-big success">${meeting.status}</span></span></td>
