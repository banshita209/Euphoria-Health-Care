					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Patient</h2>
												...
												<tbody>
													<c:forEach var="p" items="${users}">
														...
														<tr>
															...
															<td><img alt="QRcode"
																src="QRcode/${p.patient_id}.png" align="middle"></td>
															<td>${p.address.add_detail},${p.address.landmark}</br>${p.address.area},${p.address.city}-${p.address.pincode}</td>
															<td><c:choose>
																	<c:when test="${p.ifd eq 0}">
																		<a
																			href="AdminServlet?action=patient_delete&&ifd=1&&id=${p.patient_id}">Active</a>
																	</c:when>
																	<c:otherwise>
																		<a
																			href="AdminServlet?action=patient_delete&&ifd=0&&id=${p.patient_id}">InActive</a>
																	</c:otherwise>
																</c:choose></td>
														</tr>
													</c:forEach>
									...
									<div role="tabpanel" class="tab-pane show active fade"
										...
										<div class="messenger-message messenger-message-recipient">
											<div class="messenger-message-wrapper">
												...
												<div class="messenger-details">
													<span
														class="messenger-message-localisation font-size-small">3
														minutes ago</span>
												</div>
											</div>
										</div>
										...
										<div class="messenger-message messenger-message-recipient">
											<div class="messenger-message-wrapper">
												...
												<div class="messenger-details">
													<span
														class="messenger-message-localisation font-size-small">10
														minutes ago</span>
												</div>
											</div>
										</div>
