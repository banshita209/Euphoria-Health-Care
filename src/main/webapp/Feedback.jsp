		...
		<div class="row flex-row h-100">
			<div class="col-12 my-auto">
				<div class="password-form mx-auto">
					...
					<form action="CommonServlet?action=submitfeedback" method="post">
						...
						<div class="group material-input">
							<input type="email" name="f_email" required> <span class="highlight"></span>
							<span class="bar"></span> <label>Email</label>
						</div>
						<div class="group material-input">
							<input type="text" name="f_desc" required> <span class="highlight"></span>
							<span class="bar"></span> <label>Write here..</label>
						</div>

						<div class="button text-center">
							<input type="submit" class="btn btn-lg btn-gradient-01" value="Submit Feedback">
						</div>
					</form>
