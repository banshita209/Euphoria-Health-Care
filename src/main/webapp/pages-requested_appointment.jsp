					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Requested Appointment</h2>
								<div>
									<ul class="breadcrumb">
														...
														<c:forEach var="appointment" items="${appointments}">
															<tr>
																...
																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small info">${appointment.status}</span></span></td>

																<td class="td-actions"><a
																	href="DoctorServlet?action=accept_appointment&&id=${appointment.app_id}">Accept<i
																		class="la la-edit edit"></i></a></td>

																<td><a
																	href="DoctorServlet?action=deny_appointment&&type=R&&id=${appointment.app_id}">Deny</a><i
