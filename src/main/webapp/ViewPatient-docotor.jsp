					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Patient Detail</h2>
								<div>
									<ul class="breadcrumb">
									...
									<center>
										...
										<table class="text-primary">
											...
											<tr>
												...
												<td>:&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<td>${app.patient.patient_mobile }</td>
											</tr>
											<tr>
												<td>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp</td>
											</tr>
											<tr>
												...
												<td>:&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<td>${app.patient.patient_dob }</td>
											</tr>
											<tr>
												<td>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp</td>
											</tr>
											<tr>
												<td>Patient'QR Code</td>
												<td>:&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<td><img src="QRcode/${app.patient.patient_id}.png" /></td>
											</tr>
											<tr>
												<td>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp</td>
											</tr>
											<tr>
												<form action="DoctorServlet" method="post">
													<td>Change Status of appointment</td>
													<td>:&nbsp;&nbsp;
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											...
											<tr>
												...
												<td><input type="submit" class="btn btn-gradient-01"
													name="action" value="Change Status"/></td>
