							...
							<a href="db-modern.html" class="navbar-brand">
								<div class="brand-image brand-big">
									<img src="assets/img/black-logo.png" alt="logo"
										style="width: 170px;" class="logo-big">
								</div>
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav mr-auto">
									...
									<ul class="dropdown-menu" aria-labelledby="components">
											<li class="dropdown"><a href="AdminServlet?action=allpatient">Patient</a></li>
											<li class="dropdown"><a  href="AdminServlet?action=alldoctor">Doctor</a></li>
											<li class="dropdown"><a  href="AdminServlet?action=allpharmacist">Pharmacist</a></li>
											<li class="dropdown"><a  href="AdminServlet?action=allmr">Medical Representative</a></li>
									...
									<li class="dropdown"><a class="dropdown-toggle" href="#"
										...
										<ul class="dropdown-menu" aria-labelledby="components">
										<li class="dropdown"><a href="AdminServlet?action=es_display">View Emergency Services</a></li>
											<li class="dropdown"><a href="Insert(es).jsp">Add Emergency Services</a></li>
										</ul>
										</li>
										...
										<ul class="dropdown-menu" aria-labelledby="components">
											...
											<li class="dropdown"><a  href="registration(admin).jsp">Register another admin</a></li>
						...
						<div class="col-xl-6 col-md-6 os-animation"
							...
							<div class="widget widget-21 has-shadow align-items-center"
								...
								<div class="widget-body h-100 d-flex align-items-center">
									...
									<h3>Welcome ${sessionScope.user.ad_name}</h3>
