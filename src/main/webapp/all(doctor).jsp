					...
					<ul class="list-unstyled">
						...
						<li><a href="#dropdown" aria-expanded="false"
							...
							<ul id="dropdown" class="collapse list-unstyled pt-0">
								...
								<li><a href="AdminServlet?action=allpharmacist">Pharmacist</a></li>
					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Doctor</h2>
								<div>
									<ul class="breadcrumb">
									</ul>
								</div>
												...
												<tbody>
													...
													<c:forEach var="doctor" items="${users}">
														<tr>
															...
															<td>${doctor.log_email}</td>
															<td>${doctor.dr_gender}</td>
															<td>${doctor.dr_dob}</td>
															<td>${doctor.dr_mobile}</td>
															<td>${doctor.dr_qualification}</td>
															<td>${doctor.personal_address.add_detail},${doctor.personal_address.landmark}<br>${doctor.personal_address.area},${doctor.personal_address.city}-${doctor.personal_address.pincode}</td>
															...
															<td><c:choose>
																	<c:when test="${doctor.ifd eq 0}">
																		<a
																			href="AdminServlet?action=doctor_delete&&ifd=1&&id=${doctor.dr_id}">Active</a>
																	</c:when>
																	<c:otherwise>
																		<a
																			href="AdminServlet?action=doctor_delete&&ifd=0&&id=${doctor.dr_id}">InActive</a>
																	</c:otherwise>
																</c:choose></td>
														</tr>
													</c:forEach>
