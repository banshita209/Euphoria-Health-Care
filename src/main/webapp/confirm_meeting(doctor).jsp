						...
						<div class="col-xl-12 col-12">
							<div class="widget has-shadow">
								<div class="widget-body">
									...
									<form action="DoctorServlet?action=confirm_meeting"
										method="post" class="needs-validation" novalidate>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
												class="col-lg-4 form-control-label d-flex justify-content-lg-end">Medical
												representative Name </label>
											<div class="col-lg-5">
												<label
													class="col-lg-4 form-control-label d-flex justify-content-lg-end">${meeting.mr.mr_name}</label>
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
											...
											<div class="col-lg-5">
												<label
													class="col-lg-4 form-control-label d-flex justify-content-lg-end">${meeting.booking_date }</label>
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
										...
										<input type="hidden" name="id" value="${meeting.m_id}">
										<div class="form-group row d-flex align-items-center mb-5">
											<label
												class="col-lg-4 form-control-label d-flex justify-content-lg-end">Select
												appointment time (24hr)</label>
											<div class="col-lg-5">
