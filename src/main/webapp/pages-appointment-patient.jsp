...
<title>Euphoria - My appointment</title>
												...
												<tbody>
													<c:forEach var="appointment" items="${appointments}">
														<tr>
															...
															<c:if test="${appointment.status eq 'denied'}">
																<td><span style="width: 100px;"><span
															...
															<c:if test="${appointment.status eq 'visited'}">
																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small success">Visited</span></span></td>
															</c:if>
															<td><a
																href="PatientServlet?action=deny_appointment&&id=${appointment.app_id}">Deny
