				...
				<div class="row">
					<div class="page-header">
						<div class="d-flex align-items-center">
							<h2 class="page-header-title">Analysis</h2>
							<div>
								<ul class="breadcrumb">
								</ul>
							</div>
						...
						<div class="widget has-shadow">
							<div class="widget-body">
								...
								<c:if test="${empty users}">
									<h2>No analysis is uploaded by you.</h2>
								</c:if>
											...
											<tbody>
												<c:forEach var="a" items="${users}">
													...
													<tr>
														...
														<td>${a.medicalRepresentative.mr_name}</td>
														<td><a
															href="MedicalRepresentativeServlet?action=viewFile&&id=${a.ana_id}">Analysis</a></td>
														<td>${a.ana_date}</td>
