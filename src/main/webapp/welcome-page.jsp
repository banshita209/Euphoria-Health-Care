...
<html lang="en">
<head>
<title>Euphoria Health Care| Welcome page</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width">
<style type="text/css">
@import
	url('https://fonts.googleapis.com/css?family=Montserrat|Noto+Sans');
...
<body style="margin: 0; padding: 0;">
					...
					<tr>
						<td style="padding-top: 30px;">
							...
							<table width="600" border="0" cellspacing="0" cellpadding="0"
								align="center" class="responsive-table">
								<tr>
									<td align="center" valign="middle"
										style="font-size: 12px; line-height: 24px; font-family: Noto Sans, Arial, sans-serif; color: #aea9c3; padding-bottom: 35px;">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="600"
						...
						<tr>
							<td class="logo">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tr>
										<td bgcolor="#ffffff" width="90" align="left"
											style="border-radius: 4px 0 0 0;"><img alt="Logo"
											src="assets/img/white-logo.png" width="250" height="250"
										...
										<td bgcolor="#ffffff" width="400" align="right"
											class="mobile-hide" style="border-radius: 0 4px 0 0;">
											<table border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td align="right"
														...
														<span style="color: #94a4b0; text-decoration: none;">Euphoria
															health care</span>
													</td>
												</tr>
											</table>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		style="table-layout: fixed;">
		<tr>
			<td bgcolor="#1e2035" align="center" style="padding: 0 15px 0 15px;"
												...
												<tr>
													<td class="padding-copy">
														<table width="100%" border="0" cellspacing="0"
															cellpadding="0">
															<tr>
																<td><img src="assets/img/email/01.jpg" width="600"
																	height="385" border="0" alt="..."
																	style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px; width: 600px; height: 385px;"
																	class="img-max"></td>
															</tr>
														</table>
													</td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td align="center"
													...
													class="padding-copy">Welome To Euphoria Health Care!</td>
											</tr>
											<tr>
												<td align="center"
													style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Noto Sans, Arial, sans-serif; color: #aea9c3;"
													class="padding-copy">Thank you for visiting an
													Euphoria .<br>You can now login to your account or
											...
											<tr>
												<td align="center" style="padding: 25px 0 0 0;"
													...
													<table border="0" cellspacing="0" cellpadding="0"
														...
														<tr>
															<td align="center"><a
																href="pages-category.jsp?action=login"
														...
														<tr>
															...
															<td><a href="pages-category.jsp?action=register">Create
																	an account</a></td>
														</tr>
													</table>
												</td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td align="center"
													...
													class="padding-copy">Thanks!<br>The Euphoria Team
												</td>
											</tr>
										</table> <!-- End Content -->
									</td>
						...
						<td>
							...
							<table width="600" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									<td align="center" valign="middle"
										style="font-size: 12px; line-height: 24px; font-family: Noto Sans, Arial, sans-serif; color: #aea9c3; padding-bottom: 35px;">
										<span class="appleFooter" style="color: #aea9c3;">Euphoria,
