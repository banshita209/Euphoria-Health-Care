...
<title>Euphoria - Requested Appointment</title>
...
<ul class="list-unstyled">
						...
						<li class="active"><a href="#dropdown"
					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Requested Meeting</h2>
								<div>
									<ul class="breadcrumb">
										<!-- <li class="breadcrumb-item"><a href="Home(doctor).jsp"><i
						...
						<div class="col-xl-12 col-12">
							<div class="widget has-shadow">
								<div class="widget-body">
									<form class="form-horizontal" action="DoctorServlet"
										method="get">
										<!-- ///////////////////////////////////////////////// body/////////////////////////////////////////// -->
										<!-- <p class="text-primary mt-2 mb-2">Play with Elisyam :)</p> -->
										<c:if test="${empty meetings}">
											<h3>Currently no meetings are requested</h3>
											<%
												...
												<table class="table mb-0">
													...
													<tbody>
														<c:forEach var="meeting" items="${meetings}">
															<tr>
																<td><span class="text-primary">${meeting.mr.mr_name}</span></td>
																<td>${meeting.booking_date}</td>



																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small info">${meeting.status}</span></span></td>

																<td class="td-actions"><a
																	href="DoctorServlet?action=accept_meeting&&id=${meeting.m_id}">Accept<i
																		class="la la-edit edit"></i></a></td>

																<td><a
																	href="DoctorServlet?action=deny_meeting&&type=R&&id=${meeting.m_id}">Deny</a><i
																	class="la la-close delete"></i></td>
