				...
				<div class="row">
					<div class="page-header">
						<div class="d-flex align-items-center">
							<h2 class="page-header-title">Meeting</h2>
							<div>
								<ul class="breadcrumb">
								</ul>
							</div>
					...
					<div class="col-xl-12 col-12">
						<div class="widget has-shadow">
							<div class="widget-body">
								...
								<form action="MedicalRepresentativeServlet">
									<div class="table-responsive">
										<table class="table mb-0">
											...
											<tbody>
												<c:forEach var="mt" items="${users}">

													<tr>

														<td>${mt.mr.mr_name}</td>
														<td>${mt.doctor.dr_name}</td>
														<td>${mt.booking_date}</td>
														<td>${mt.appointment_date}</td>
														<td>${mt.appointment_time}</td>
														<%-- <td>${mt.status}</td> --%>
														<c:if test="${mt.status eq 'accepted'}">
																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small success">
																			Accepted</span></span></td>
															</c:if>
															<c:if test="${mt.status eq 'denied'}">
																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small danger">Denied</span></span></td>
															</c:if>
															<c:if test="${mt.status eq 'pending'}">
																<td><span style="width: 100px;"><span
																		class="badge-text badge-text-small info">Pending</span></span></td>
															</c:if>
													</tr>
												</c:forEach>
											</tbody>
