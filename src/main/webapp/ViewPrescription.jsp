															...
															<td>
																<div class="col-xl-8 d-flex align-items-center mb-3">
																	<button type="button" class="btn btn-outline-success mr-1 mb-2"
																		data-toggle="modal"
																		data-target="#modal-centered${p.pr_id}">Read</button>
																</div>
																	...
																	<div id="modal-centered${p.pr_id}" class="modal fade">
																		<div class="modal-dialog modal-dialog-centered">
																			<div class="modal-content">
																				...
																				<input type="text" hidden name="pr_id"
																					value="${p.pr_id}" /> <input type="text" hidden
																					name="patient_id"
																					value="${p.prescribed_to.patient_id}" />
																				<div class="modal-footer">
																					<button type="button" class="btn btn-shadow"
																						data-dismiss="modal" name="action" value="denny">Deny</button>
