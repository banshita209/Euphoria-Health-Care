				...
				<nav class="side-navbar box-scroll sidebar-scroll">
					...
					<ul class="list-unstyled">
						...
						<li class="active"><a href="#dropdown-db"
							aria-expanded="false" data-toggle="collapse"><span>Meetings</span></a>
					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Todays Meetings</h2>
								<div>
									<ul class="breadcrumb">
										<!-- <li class="breadcrumb-item"><a href="db-all.html"><i
												class="ti ti-home"></i></a></li>
										<li class="breadcrumb-item active">Todays Meetings</li> -->
									</ul>
								</div>
							</div>
						</div>
													...
													<c:forEach var="meeting" items="${meetings}">
														<tr>
															...
															<td><span style="width: 100px;"><span
																	class="badge-text badge-text-large success">${meeting.status}</span></span></td>
															<td><a href="DoctorServlet?action=changeStatusvisited&&m_id=${meeting.m_id}"
																class="btn btn-gradient-01">Change Status to Visited</a></td>

															<td><a
																href="DoctorServlet?action=deny_meeting&&type=A&&id=${meeting.m_id}">Deny</a>
																<i class="la la-close delete"></i></td>
