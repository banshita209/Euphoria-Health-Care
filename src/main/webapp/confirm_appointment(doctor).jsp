						...
						<div class="col-xl-12 col-12">
							<div class="widget has-shadow">
								<div class="widget-body">
									...
									<form action="DoctorServlet?action=confirm_appointment"
										method="post" class="needs-validation" novalidate>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
												class="col-lg-4 form-control-label d-flex justify-content-lg-end">Patient
												Name </label>
											<div class="col-lg-5">
												<label
													class="col-lg-4 form-control-label d-flex justify-content-lg-end">${appointment.patient.patient_name}</label>
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
												class="col-lg-4 form-control-label d-flex justify-content-lg-end">Booking
												Date </label>
											<div class="col-lg-5">
												<label
													class="col-lg-4 form-control-label d-flex justify-content-lg-end">${appointment.booking_date }</label>
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
											...
											<div class="col-lg-5">
												<input type="date" name="appointment_date" id="name"
													class="form-control" placeholder="Enter your name">
											</div>
										</div>
										<input type="hidden" name="id" value="${appointment.app_id}">
										<div class="form-group row d-flex align-items-center mb-5">
											<label
												class="col-lg-4 form-control-label d-flex justify-content-lg-end">Select
												Appointment time (24hrs)</label>
											<div class="col-lg-5">
												<input type="time" name="appointment_time" id="name"
													class="form-control" placeholder="Enter your name">
											</div>
										</div>
