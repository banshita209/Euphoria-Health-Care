...
<body>
	...
	<div class="nav">
		<ul>
			<li><a href="Home(mr).jsp"><i class="fas fa-home"></i> Home
			</a></li>

			<li><a href="MedicalRepresentativeServlet?action=profile"><i
					class="fas fa-user-circle"></i> Profile</a></li>
			<li><a href="UploadAnalysis.jsp"><i class="fas fa-comment"></i>
					Upload analysis</a></li>
			<li><a href="MedicalRepresentativeServlet?action=get_area">Book
					a Meeting </a></li>
