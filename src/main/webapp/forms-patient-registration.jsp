...
<script type="text/javascript">
	...
	function makeRequest() {
		...
		alert("OTP is send to your email id. Check yor mails");
	}
		...
		return function() {
			if (xmlHttpRequest.readyState == 4) {
				if (xmlHttpRequest.status == 200) {
					//alert("Check Your Emails" + xmlHttpRequest.responseText);
						...
						<div class="col-xl-12">
							...
							<div class="widget has-shadow">
								<div
									...
									<h4>Patient's Registration Form</h4>
								</div>
								<div class="widget-body">
									<form action="PatientServlet?action=registration" method="post"
										...
										<div class="form-group row d-flex align-items-center mb-5">
											...
											<div>
												<input id="checkpass" type="checkbox" onclick="myFunction()" />Show
												Password
											</div>
										...
										<div class="form-group row mb-5">
											...
											<div class="col-lg-1">
												<div class="custom-control custom-radio styled-radio mb-3">
													<input class="custom-control-input" type="radio"
														name="gender" id="opt-01" value="Female" required>
													<label class="custom-control-descfeedback" for="opt-01">Female</label>
													<div class="invalid-feedback">Toggle this custom
														radio</div>
												</div>
											</div>
											...
											<div class="col-lg-1">
												<div class="custom-control custom-radio styled-radio mb-3">
													...
													<div class="invalid-feedback">Or toggle this other
														custom radio</div>
												</div>
											</div>
										...
										<div class="form-group row d-flex align-items-center mb-5">
											...
											<div class="col-lg-5">
												<input type="text" class="form-control"
													placeholder="house no & society" name="p_add_detail"
													required>
												<div class="invalid-feedback">Please enter a valid
													house no or scoiety name</div>
											</div>
										</div>
