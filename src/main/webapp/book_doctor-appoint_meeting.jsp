...
<title>Euphoria - Book meeting with doctor</title>
				...
				<nav class="side-navbar box-scroll sidebar-scroll">
					...
					<c:if test="${sessionScope.category eq 'mr'}">
						...
						<ul class="list-unstyled">
							...
							<li><a href="MedicalRepresentativeServlet?action=profile">
									Profile</a></li>
								...
								<div class="widget-body">
									...
									<c:if test="${sessionScope.category eq 'mr'}">
										<form class="form-horizontal"
											action="MedicalRepresentativeServlet" method="post">
									</c:if>
									<c:if test="${sessionScope.category eq 'patient'}">

										<form class="form-horizontal" action="PatientServlet"
											method="post">
									</c:if>
									...
									<div class="form-group row d-flex align-items-center mb-5">
										...
										<div class="col-lg-5">
											<div class="select">
												<select name="source" class="custom-select " required>
										...
										<center>
											<div class="col-lg-5">
												<button class="btn btn-gradient-01" name="action"
													value="search_doctor">Search Doctor</button>
											</div>
										</center>
											...
											<table class="table mb-0">
												<thead>
													<tr>
														...
														<th>Doctor's specaility</th>
														<th>Doctor's experience</th>
														<th>Doctor's visiting_fees</th>
														<th>Doctor'gender</th>
												...
												<tbody>
													<c:forEach var="doctor" items="${doctors}">
														...
														<tr>
															...
															<td>${doctor.clinic_address.add_detail},${doctor.clinic_address.landmark}<br>${doctor.clinic_address.area},${doctor.clinic_address.city}-${doctor.clinic_address.pincode}</td>
																...
																<td>
																	<div class="row">
																		...
																		<div class="col-xl-8 d-flex align-items-center mb-3">
																			<a
																				href="MedicalRepresentativeServlet?action=RequestForMeeting&&id=${doctor.dr_id}"><button
																					type="button" class="btn btn-gradient-01"
																					data-toggle="modal" data-target="#delay-modal">Request
																					for Meeting</button></a>
																		</div>
																	</div>
																</td>
															</c:if>
															<c:if test="${sessionScope.category eq 'patient'}">
																<td><a
																	href="PatientServlet?action=RequestForAppointment&&id=${doctor.dr_id}"><button
																			type="button" class="btn btn-gradient-01"
																			data-toggle="modal" data-target="#delay-modal">Request
																			for appointment</button></a></td>
															</c:if>
														</tr>
													</c:forEach>
												</tbody>
						...
						<div
							...
							<ul class="nav">
								...
								<li class="nav-item"><a class="nav-link"
									href="changelog.html">euphoria.abgp@gmail.com</a></li>
							</ul>
						</div>
					</div>
				</footer>
			...
			<div class="modal-content">
				<div class="modal-body text-center">
					...
					<div class="section-title mt-5 mb-2">
						...
						<h2 class="text-gradient-01">thanks!!!!</h2>

					</div>
					<p class="mb-5">Your request has been submitted successfully</p>
				</div>
			</div>
		</div>
	</div>
