...
<title>Euphoria - All Report</title>
										...
										<div class="table-responsive">
											<table class="table mb-0">
												<thead>
													<tr>
														<th>Patient</th>
														<th>Upload Date <br>(yyyy-mm-dd format)
														</th>
												...
												<tbody>
													<c:forEach var="r" items="${reports}">
														<tr>
															<td><span class="text-primary">${r.patient.patient_name}</span></td>
															<td>${r.r_date}</td>
															<td><a
																href="PatientServlet?action=viewReport&&r_id=${r.r_id}"><button
																		type="button" class="btn btn-outline-info mr-1 mb-2">View</button></a></td>
