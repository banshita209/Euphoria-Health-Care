					...
					<div class="row">
						<div class="page-header">
							<div class="d-flex align-items-center">
								<h2 class="page-header-title">Medical Representative</h2>
								<div>
									<ul class="breadcrumb">
										</ul>
								</div>
												...
												<tbody>
													<c:forEach var="m" items="${users}">
														...
														<tr>
															...
															<td>${m.mr_mobile}</td>
															<td>${m.workArea}</td>
															<td>${m.address.add_detail},${m.address.landmark}</br>${m.address.area},${m.address.city}-${m.address.pincode}</td>
															<td><c:choose>
																	<c:when test="${m.ifd eq 0}">
																		<a href="AdminServlet?action=mr_delete&&ifd=1&&id=${m.mr_id}">Active</a>
																	</c:when>
																	<c:otherwise>
																		<a href="AdminServlet?action=mr_delete&&ifd=0&&id=${m.mr_id}">InActive</a>
																	</c:otherwise>
																</c:choose></td>
														</tr>
													</c:forEach>
