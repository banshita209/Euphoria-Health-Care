		...
		<div class="page-content d-flex align-items-stretch">
			<div class="default-sidebar">
				...
				<ul class="list-unstyled">
					<li><a href="Header(pharmacist).jsp">Home</i>
					</a></li>
						...
						<div class="col-xl-9">
							<div class="widget has-shadow">
								...
								<div class="widget-body">
									...
									<form action="PharmacistServlet?id=${user.phst_id}"
										...
										<div class="form-group row d-flex align-items-center mb-5">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" name="name"
													value="${user.phst_name}" required
													title="only string allowed" /> <input type="hidden"
													name="id" value="${user.phst_name}" />
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
										...
										<div class="form-group row d-flex align-items-center mb-5">
											...
											<div class="col-lg-6">
												<input type="text" class="form-control" name="mobile"
													required pattern="[0-9]{10}" value="${user.phst_mobile }" />
											</div>
										</div>
										<div class="form-group row d-flex align-items-center mb-5">
											<label
											...
											<div class="form-group row d-flex align-items-center mb-5">
												...
												<br> <br>
														...
														<div class="col-lg-1">
															...
															<div
																class="custom-control custom-radio styled-radio mb-3">
