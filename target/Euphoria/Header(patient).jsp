...
<body>
	...
	<div class="nav">
		<ul>
			<li><a href="Home(patient).jsp"><i class="fas fa-home"></i>
					Home </a></li>

			<li><a href="PatientServlet?action=profile"><i
					class="fas fa-user-circle"></i> Profile</a></li>
			<li><a href="PatientServlet?action=HealthTracker">Health
					Tracker</a></li>
			<li><a href="PatientServlet?action=get_area">Book a
					appointment </a></li>
			<li><a href="PatientServlet?action=get_all_appointment">Your
					Appointments</a></li>
			<li><a href=" "><i class="fas fa-file-medical-alt"></i> Get
					a prescripiton</a></li>
			<li><a href=" ">Get medicines</a></li>
			...
			<li><a href="https://www.webmd.com/first-aid/default.htm"
				target="new"><i class="fas fa-first-aid"></i> First Aid</a></li>
