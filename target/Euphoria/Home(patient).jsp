...
<body>
	...
	<div>
		<center>
			<img src="images/patient.png" alt="patient_logo" height="400px"
				width="400px" />
			<h3>
				<c:if test="${sessionScope.user.patient_gender eq 'Female'}">
					Welcome Miss ${sessionScope.user.patient_name}
				</c:if>
				<c:if test="${sessionScope.user.patient_gender eq 'Male'}">
					Welcome Mr ${sessionScope.user.patient_name}
				</c:if>
			</h3>
		</center>
	</div>
