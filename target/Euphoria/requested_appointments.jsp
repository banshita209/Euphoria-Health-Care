			...
			<table border="1">
				...
				<c:forEach var="appointment" items="${appointments}">
					<tr>
						...
						<td><a
							href="DoctorServlet?action=accept_appointment&&id=${appointment.app_id}">Accept</a></td>
						<td><a
							href="DoctorServlet?action=deny_appointment&&type=R&&id=${appointment.app_id}">Deny</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
