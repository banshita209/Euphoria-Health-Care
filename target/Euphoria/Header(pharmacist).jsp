...
<body>
	...
	<div class="nav">
		<ul>
			<li><a href="Home(pharmacist).jsp"><i class="fas fa-home"></i>
					Home </a></li>

			<li><a href="PharmacistServlet?action=profile"><i
					class="fas fa-user-circle"></i> Profile</a></li>


			<li><a href=" "><i class="fas fa-file-medical-alt"></i> View
					Prescription </a></li>

			<li><a href=" "><i class="fas fa-file-medical-alt"></i> Give
					Medicine </a></li>
